    ...
    public partial class CandidateManagementContext : DbContext
    {
        ...
        private String GetConnectionString()
        {
            IConfiguration config = new ConfigurationBuilder()
                ...
                .Build();
            var strConn = config.GetConnectionString("CandidateDB");
            return strConn;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CandidateProfile>(entity =>
            {
                entity.HasKey(e => e.CandidateId)
                    .HasName("PK__Candidat__DF539BFC81CBF8DA");
            ...
            modelBuilder.Entity<Hraccount>(entity =>
            {
                entity.HasKey(e => e.Email)
                    .HasName("PK__HRAccoun__A9D105356B25767A");
            ...
            modelBuilder.Entity<JobPosting>(entity =>
            {
                entity.HasKey(e => e.PostingId)
                    .HasName("PK__JobPosti__C31796A525037067");
